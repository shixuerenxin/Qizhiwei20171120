...
public class FragmentShow3 extends Fragment implements IView{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.layout_show2, null, false);
        viewById = (RecyclerView)inflate.findViewById(R.id.rlv_show2);
        list = new ArrayList<>();
